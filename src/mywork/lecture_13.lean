...
--if there's a ball thats red and green then there is a ball
-- that is red
example : 
...
example : 
-- if there is a person who evereyone likes then
-- each person like someone else
