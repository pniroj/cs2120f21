...
Theorem: 2 = 2.
Proof: [By the equality property (=) the left side of the equation is equal to the right]
...
-- By the reflexive property, if every object is equal to itself then a particular object is also equal to itself

example: 2 = 2 ;=@eq.refl N 2
