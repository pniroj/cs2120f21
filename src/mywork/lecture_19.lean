...
/- we want to prove that {0, 2} are in the set of
evens. consider each element in {0, 2} and show
that each element in the set satisfies the proof
for even
-/
...
begin
  ...
  cases h,
  -- case: n = 0
  rw h, --substitution when there is =
  /-
  unfold evens,
  show {n : ℕ | n % 2 = 0} 0,
  show 0 % 0 = 0,
